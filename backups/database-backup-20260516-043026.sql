...
INSERT INTO `announcements` (`announcement_id`, `title`, `content`, `image_path`, `type`, `published_by`, `published_date`, `expiry_date`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES ('1', 'ssd', 'dsdsd', NULL, 'schedule', '1', '2026-05-07 19:37:37', NULL, 'active', '2026-05-07 19:37:37', '2026-05-07 19:37:37', NULL);
INSERT INTO `announcements` (`announcement_id`, `title`, `content`, `image_path`, `type`, `published_by`, `published_date`, `expiry_date`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES ('2', 'jznajzj', 'kaznkaznka', NULL, 'schedule', '4', '2026-05-08 20:46:00', NULL, 'active', '2026-05-08 20:46:00', '2026-05-08 20:46:00', NULL);
...
CREATE TABLE `users` (
  ...
  `status` enum('active','inactive','pending_verification','rejected') DEFAULT 'active',
...
INSERT INTO `users` (`id`, `fullname`, `phone_number`, `email`, `chapel_district`, `address`, `password`, `role`, `status`, `profile_picture`, `valid_id_path`, `rejection_reason`, `verified_at`, `verified_by`, `created_at`, `updated_at`) VALUES ('1', 'Admin User', '', 'admin@parish.com', NULL, NULL, '$2y$10$4SOqfUllLomRA4aPdbsBDOlwYl8HRJKtYhovw5JrmAbUN3iHmspTG', 'admin', 'active', NULL, NULL, NULL, NULL, NULL, '2026-05-07 11:52:23', '2026-05-07 19:17:15');
INSERT INTO `users` (`id`, `fullname`, `phone_number`, `email`, `chapel_district`, `address`, `password`, `role`, `status`, `profile_picture`, `valid_id_path`, `rejection_reason`, `verified_at`, `verified_by`, `created_at`, `updated_at`) VALUES ('4', 'Admin', '555-0000', 'admin@gmail.com', 'Main Chapel', NULL, '$2y$10$4SOqfUllLomRA4aPdbsBDOlwYl8HRJKtYhovw5JrmAbUN3iHmspTG', 'admin', 'active', NULL, NULL, NULL, NULL, NULL, '2026-05-07 12:04:29', '2026-05-07 19:17:15');
INSERT INTO `users` (`id`, `fullname`, `phone_number`, `email`, `chapel_district`, `address`, `password`, `role`, `status`, `profile_picture`, `valid_id_path`, `rejection_reason`, `verified_at`, `verified_by`, `created_at`, `updated_at`) VALUES ('5', 'REYMARK', '09635866550', 'reymarkcavanas0@gmail.com', 'East District', NULL, '$2y$10$IHJbcO8C1c/EvOMrja6zEOhHdRiK7LSJBAhbcditzdknzy/SbtbAy', 'user', 'active', NULL, NULL, NULL, NULL, NULL, '2026-05-07 12:06:18', '2026-05-07 12:06:18');
INSERT INTO `users` (`id`, `fullname`, `phone_number`, `email`, `chapel_district`, `address`, `password`, `role`, `status`, `profile_picture`, `valid_id_path`, `rejection_reason`, `verified_at`, `verified_by`, `created_at`, `updated_at`) VALUES ('6', 'dimpol', '09635866550', 'dimpowalabalo@gmail.com', 'Central Parish', NULL, '$2y$10$HF36TcM5yvgvNidZ6Lc9sOeGhLGycdLwBD5oIZyJSykHb2W2VW.Qq', 'user', 'active', NULL, NULL, NULL, NULL, NULL, '2026-05-07 19:40:18', '2026-05-07 19:40:18');
INSERT INTO `users` (`id`, `fullname`, `phone_number`, `email`, `chapel_district`, `address`, `password`, `role`, `status`, `profile_picture`, `valid_id_path`, `rejection_reason`, `verified_at`, `verified_by`, `created_at`, `updated_at`) VALUES ('7', 'hazel gadingan', '09123456789', 'blabla@gmail.com', 'Main Chapel', NULL, '$2y$10$7DJHvL6u//kLUlS7S5dZW.eiaj7jJCZpgl8xeMYV3iQDNow74DQPi', 'user', 'active', NULL, NULL, NULL, NULL, NULL, '2026-05-15 13:15:55', '2026-05-15 13:15:55');
INSERT INTO `users` (`id`, `fullname`, `phone_number`, `email`, `chapel_district`, `address`, `password`, `role`, `status`, `profile_picture`, `valid_id_path`, `rejection_reason`, `verified_at`, `verified_by`, `created_at`, `updated_at`) VALUES ('8', 'prince ondoy', '09631237247', 'princeondoy0@gmail.com', 'Main Chapel', NULL, '$2y$10$FSUsZSU7lcNgVMD48mom4uKCkc4VOlSXNZMdP6SHmep2Sg1ug7I7a', 'user', 'active', NULL, NULL, NULL, NULL, NULL, '2026-05-15 21:06:15', '2026-05-15 21:06:15');
INSERT INTO `users` (`id`, `fullname`, `phone_number`, `email`, `chapel_district`, `address`, `password`, `role`, `status`, `profile_picture`, `valid_id_path`, `rejection_reason`, `verified_at`, `verified_by`, `created_at`, `updated_at`) VALUES ('9', 'qwerty', '09123456789', 'qwerty@gmail.com', 'Main Chapel', 'San Mateo, Aleosan, Cotabato', '$2y$10$epek1yVmKtPM0q50q2nbhenz32TsNHCI0bGXAGFOr4qjuuouKirtC', 'user', 'active', NULL, 'uploads/valid_ids/valid-id-20260515184224-10dd9cbe06fc.png', NULL, '2026-05-16 00:45:28', '4', '2026-05-16 00:42:24', '2026-05-16 00:45:28');
