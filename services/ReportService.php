...
{
    public const TYPES=['all','turnaround','pending_overdue','notifications'];
    ...
    {
        $clauses=[$base];$types='';$values=[];$dateColumn=match($type){'notifications'=>'COALESCE(nd.last_attempt_at,n.created_at)',default=>'r.date_requested'};
    ...
    {
        $range='';$types='';$values=[];$column=match($type){'notifications'=>'COALESCE(nd.last_attempt_at,n.created_at)',default=>'r.date_requested'};
