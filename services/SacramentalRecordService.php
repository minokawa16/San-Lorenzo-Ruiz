...
final class SacramentalRecordService
{
    ...
    private const TYPES = [
        ...
        'marriage' => [
            ...
            'request_types' => ['marriage_certificate','marriage_certification','marriage_wedding_service'],
        ...
        'funeral' => [
            ...
            'request_types' => ['funeral_mass','funeral_certificate','funeral_certification'],
