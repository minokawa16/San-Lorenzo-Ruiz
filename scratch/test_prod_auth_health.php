...
$cookieFile = __DIR__ . '/test_prod_auth_cookie.txt';
...
echo "Production Login Status: {$loginResp['status']} | Final URL: {$loginResp['url']}\n";
$isDashboard = strpos($loginResp['url'], 'dashboard.php') !== false;
echo "Admin Login Authenticated Successfully: " . ($isDashboard ? "YES" : "NO") . "\n";
