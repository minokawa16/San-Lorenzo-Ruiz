...
function defaultCertificateLayoutSettings($certificate_type) {
    return [
        'static_text' => [
            ...
            'certificate_title' => $certificate_type === 'baptism' ? 'CERTIFICATE OF BAPTISM' : strtoupper(certificateTemplateTypeLabel($certificate_type)),
            ...
            'bible_verse' => '',
            'official_remarks' => '',
            'priest_name' => 'REV. FR. HERIBERTO C. VILLAS, O.M.I.',
            'priest_position' => 'Priest-in-Charge',
            'secretary_name' => '',
