-- Migration 025: Ensure Baptism Record 3 and any Juan Manuel entries are updated to Rey Mark Cantomayor Cavañas
...
UPDATE baptism_records SET 
    ...
    book_no = '1',
    page_no = '2'
WHERE baptism_id = 3 OR fullname LIKE '%JUAN MANUEL%' OR fullname LIKE '%JUVAN%';

UPDATE certificate_issuances 
SET issued_to = 'REY MARK CANTOMAYOR CAVAÑAS' 
WHERE record_table = 'baptism_records' AND (record_id IN (1, 2, 3) OR issued_to LIKE '%JUAN MANUEL%');
