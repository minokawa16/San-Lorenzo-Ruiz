        ...
        <div class="card-body">
            ...
            <form method="GET" class="mb-3">
                ...
                <div class="table-search-control-bar d-flex align-items-center gap-3">
                    <input type="text" class="form-control parish-table-search-input" name="search" placeholder="Search by name, email, or address..." value="<?php echo sanitize($search); ?>" style="height: 40px; border-radius: 8px; border: 1px solid #d8d6cc; background: #ffffff;">
