    ...
    <div class="card">
        <div class="card-body">
            ...
            <?php if (!empty($parishioners)): ?>
                        ...
                        <tbody>
                            <?php foreach ($parishioners as $parishioner): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#<?php echo e($modal_id); ?>" data-stable-modal-open="#<?php echo e($modal_id); ?>" title="View Parishioner Details">
                                        ...
                                        <?php if ($parishioner['status'] !== 'archived'): ?>
                                            <form method="POST" action="" class="d-inline" onsubmit="return confirm('Archive this parishioner? The record will be hidden from the active parishioner list.');">
                                                ...
                                                <button type="submit" class="btn btn-sm btn-outline-secondary" title="Archive Parishioner">
                ...
                <!-- Modals rendered outside table for valid DOM and proper Bootstrap behavior -->
                <?php foreach ($parishioners as $parishioner): ?>
                    <?php
                    ...
                    ?>
                    <div class="modal fade stable-detail-modal" id="<?php echo e($modal_id); ?>" tabindex="-1" aria-labelledby="<?php echo e($modal_id); ?>Label" aria-hidden="true">
                        <div class="modal-dialog modal-xl modal-dialog-scrollable">
                            <div class="modal-content rounded-4 border-0 shadow">
                                                ...
                                                <?php if ($front_id_url): ?>
                                                    <div class="col-md-4">
                                                        <a href="<?php echo e($front_id_url); ?>" target="_blank" class="d-block text-decoration-none">
                                                            ...
                                                            <span class="btn btn-sm btn-outline-primary w-100"><i class="fas fa-external-link-alt me-1"></i> Open Valid ID Front</span>
                                                        </a>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if ($back_id_url): ?>
                                                    <div class="col-md-4">
                                                        <a href="<?php echo e($back_id_url); ?>" target="_blank" class="d-block text-decoration-none">
                                                            ...
                                                            <span class="btn btn-sm btn-outline-primary w-100"><i class="fas fa-external-link-alt me-1"></i> Open Valid ID Back</span>
                                                        </a>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if ($face_url): ?>
                                                    <div class="col-md-4">
                                                        <a href="<?php echo e($face_url); ?>" target="_blank" class="d-block text-decoration-none">
                                                            ...
                                                            <span class="btn btn-sm btn-outline-primary w-100"><i class="fas fa-external-link-alt me-1"></i> Open Face Image</span>
                                                        </a>
                                                    </div>
                                                <?php endif; ?>
                                ...
                                <div class="modal-footer bg-light">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" data-stable-modal-close>Close</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <?php if ($pagination['total_pages'] > 1): ?>
                    <nav class="mt-4" aria-label="Parishioner page navigation">
                        <ul class="pagination justify-content-center">
                            <?php if ($pagination['has_prev']): ?>
                                <li class="page-item">
                                    <a class="page-link" href="manage-parishioners.php?page=<?php echo $pagination['prev_page']; ?>&scope=<?php echo urlencode($scope); ?>&search=<?php echo urlencode($search); ?>">&laquo; Prev</a>
                                </li>
                            <?php else: ?>
                            ...
                            <?php for ($p = 1; $p <= $pagination['total_pages']; $p++): ?>
                                <li class="page-item <?php echo $p === $pagination['current_page'] ? 'active' : ''; ?>">
                                    <a class="page-link" href="manage-parishioners.php?page=<?php echo $p; ?>&scope=<?php echo urlencode($scope); ?>&search=<?php echo urlencode($search); ?>"><?php echo $p; ?></a>
                                </li>
                            <?php endfor; ?>

                            <?php if ($pagination['has_next']): ?>
                                <li class="page-item">
                                    <a class="page-link" href="manage-parishioners.php?page=<?php echo $pagination['next_page']; ?>&scope=<?php echo urlencode($scope); ?>&search=<?php echo urlencode($search); ?>">Next &raquo;</a>
                                </li>
                            <?php else: ?>
