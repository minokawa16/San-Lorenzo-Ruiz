...
<style>
    ...
    .editor-canvas { width: 8.5in; height: 6.5in; position: relative; margin: 0 auto; background: #fff; box-shadow: 0 18px 44px rgba(15,23,42,.22); overflow: hidden; font-family: "Times New Roman", serif; color: #151515; }
